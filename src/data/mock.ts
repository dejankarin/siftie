import type { Message, PortfolioPrompt, PromptFilter, Source } from '../types';
...
export const INITIAL_SOURCES: Source[] = [
  {
    ...
    snippet:
      '"…we exist for runners who don\'t identify as athletes. Our buyer is the 32-year-old who started running during the pandemic and wants kit that doesn\'t scream Strava."',
  },
  {
    id: 's2',
    type: 'url',
    ...
    snippet:
      'Heritage running brand. Premium positioning ($88 tee, $148 short). Anchors on "amateur spirit" and Boston/New England running culture. Strong editorial content moat.',
  },
  {
    id: 's3',
    type: 'paste',
...
export const INITIAL_PROMPTS: PortfolioPrompt[] = [
...
export const PROMPT_FILTERS: PromptFilter[] = ['All', 'Category', 'Persona', 'Comparison'];
